...
public class SimplePopup {
    ...
    private static boolean anyPopups;
    ...
    void initialize() {
        ...
        if (isButtonShows) {
            simplePopupOkButton.setOnAction(e -> {
                close();
            });
        } else {
    ...
    public void forceSetupWindow(String message) {
        window.close();
        anyPopups = false;

        Platform.runLater(() -> new SimplePopup().setupWindow(message));
    }
